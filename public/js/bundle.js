...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"singup.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:9000/api/v1/users/updatePassword' : 'http://localhost:9000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_5W4XHflxYa0Cm97ADYZMxr3600utYa4yzD');
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(mobileId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:9000/api/v1/bookings/checkout-session/".concat(mobileId));

          case 3:
            session = _context.sent;
            console.log(session); //2)Create checkout from +chance credait card
  ...
  return function bookMobile(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookMobile = bookMobile;
...
var userDataForm = document.querySelector('.form--update');
var userPasswordChange = document.querySelector('.form--update-password');
var bookBtn = document.getElementById('addbutton');
...
if (userPasswordChange) {
  userPasswordChange.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var mobileId = e.target.dataset.mobileId;
  (0, _stripe.bookMobile)(mobileId);
});
